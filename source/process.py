...
if __name__=="__main__":
    ...
    pd.concat([train_df['target'], pd.DataFrame(train_imputed, columns=train_df.columns, index=train_df.index)],  axis=1).to_csv(train_features_output_path, index=True, header=True)
